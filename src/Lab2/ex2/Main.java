...
public class Main {
    public static void main(String[] args) {
        ...
        //System.out.println(studioDatabase[1];
        //System.out.println(studioDatabase[0].getFilme());

        for (int i = 0; i < studioDatabase.length; i++) {
            if (studioDatabase[i].number > 2) {
                System.out.println("Studio Name are: " + studioDatabase[i].getNume());
            }
        }

        for(Studio s2 : studioDatabase)
            for(Film f : s2.getFilme())
...
//        for (int i = 0; i< studioDatabase.length ; i++) {
//            if (studioDatabase[i].takeActorName(actorOscar1990) == "actor cu 2 oscaruri") {
//                System.out.println(studioDatabase[i].getNume());
//            }
//        }

        //System.out.println(studioDatabase[0].takeActorName(actorOscar1990));
